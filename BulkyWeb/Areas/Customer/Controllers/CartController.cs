...
namespace BulkyWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPOST()
        {
            ...
            // used bindproperty above which already binds all the names of this particular posted orderheader in this hence no need to define each property and bind it after bringing a ViewModel model
